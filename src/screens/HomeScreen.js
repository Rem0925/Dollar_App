  ...
  const renderCalendarGrid = () => {
    ...
    for (let d = 1; d <= daysInMonth; d++) {
      ...
      grid.push(
        ...
        >
          <Text style={[styles.calDayText, hasData && styles.calDayTextActive]}>
            {d}
          </Text>
        </TouchableOpacity>
      );
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
          ...
          {isUpdating ? (
            ...
            >
              ...
              <Text style={styles.date}>
                {selectedDateStr
                  ? `Histórico: ${fixDate(data?.fecha, true)}`
                  : fixDate(data?.fecha)}
              </Text>
              <CaretRight
                color={COLORS.textSecondary}
        ...
        <View style={{ flexDirection: "row", gap: 10 }}>
          ...
          <TouchableOpacity
            style={[styles.iconBtn, showCalculator && styles.activeBtn]}
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.calGridHeader}>
              {["Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa"].map((d, i) => (
                <Text key={i} style={styles.calHeaderDay}>
                  {d}
                </Text>
              ))}
            </View>
